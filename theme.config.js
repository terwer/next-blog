...
export default {
  projectLink: "https://github.com/terwer/next-blog",
  docsRepositoryBase: "https://github.com/terwer/next-blog",
  titleSuffix: "",
  search: true,
    ...
    return (
      <>
        ...
        <span
          ...
          title={"terwer: " + (TITLE_WITH_TRANSLATIONS[locale] || "")}
        >
          terwer
        </span>
      </>
  ...
  head: ({ title, meta }) => {
    ...
    return (
      <>
        ...
        <meta name="apple-mobile-web-app-title" content="terwer" />
      </>
    );
  },
